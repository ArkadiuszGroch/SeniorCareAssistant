...
public class AccountController {
	...
	public @ResponseBody ResponseEntity<String> loginSenior(@RequestBody Senior senior) {
		try{
	...
	public @ResponseBody ResponseEntity<String> registerCareAssistant(@RequestBody CareAssistant careAssistant) {
		try{
	...
	public @ResponseBody ResponseEntity<String> loginCareAssistant(@RequestBody CareAssistant careAssistant) {
		try{
